...
import { User, Country, SparePart, ConfigPartCombo, Currency, ListTypeItem, ResultMsg, ProfileReadOnly, ConfigTypeValue } from '../_models';
        ...
        .subscribe({
          next: (data: any) => {
            if (data.object.image != null) {
              ...
              this.imagePath = data.object.image;
            }
            else {
              this.imageUrl = this.noimageData;
            }
