...
var MasterListComponent = /** @class */ (function () {
    function MasterListComponent(formBuilder, route, router, accountService, alertService, masterlistService, notificationService, profileService) {
    ...
    MasterListComponent.prototype.createColumnDefs = function () {
        return [
            {
                headerName: 'Action',
                field: 'id',
